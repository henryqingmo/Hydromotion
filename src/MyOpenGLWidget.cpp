...
//void MyOpenGLWidget::setCurrentWorkingDirectory(const QString &currentDir)
//{
//    QDir::setCurrent(currentDir);
//    QString dir = QCoreApplication::applicationDirPath();
//    m_vertexShaderPath = dir + "/" + "src/shaders/vertexShader.vert";
//    m_fragmentShaderPath = dir + "/" + "src/shaders/fragmentShader.frag";
